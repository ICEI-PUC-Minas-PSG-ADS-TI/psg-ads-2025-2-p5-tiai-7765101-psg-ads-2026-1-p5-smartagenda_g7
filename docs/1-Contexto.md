...
## 1.2 Objetivos  
Geral: O objetivo é desenvolver um agenda pessoal inteligente que otimize o planejamento da rotina e reduza a procrastinação por meio da automação de registros e da análise contextual de tempo, ou seja, umentar a produtivide do usuário, e incentivar os usuários a planejar tarefas de maneira prática. <br>
Objetivos Específicos:
  ...
  - Implementar o gerenciamento de tarefas, com ou sem datas finais.
